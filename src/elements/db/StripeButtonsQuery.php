...
class StripeButtonsQuery extends ElementQuery
{
    ...
    protected function beforePrepare(): bool
    {
        ...
        $this->query->select([
            ...
            'enupalstripe_buttons.singlePlanSetupFee',
            'enupalstripe_buttons.singlePlanInfo',
            'enupalstripe_buttons.enableCustomPlanAmount',
            'enupalstripe_buttons.customPlanMinimumAmount',
            'enupalstripe_buttons.customPlanDefaultAmount',
